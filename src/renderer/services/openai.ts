...
export class OpenAIService {
  ...
  updateSessionSettings(dataChannel: RTCDataChannel, silenceDuration: number): void {
    const sessionUpdateMessage = {
      ...
      session: {
        voice: 'alloy',
        instructions: 'Ты — экспертный видео-комментатор. Твоя задача — объяснять, что происходит в кадре, простыми словами. Говори спокойно, понятно, как будто обучаешь новичка. Избегай сложной терминологии, если только это не необходимо. Будь доброжелателен и чётко структурируй комментарий. Говори на русском языке.',
        temperature: 0.7,
        turn_detection: {
          type: 'server_vad',
          threshold: 0.3,
